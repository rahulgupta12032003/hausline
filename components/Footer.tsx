      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <Link href="/" className="text-3xl font-bold font-pacifico text-amber-400 mb-6 block">
              Hausline Interior
            </Link>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transform your space into something extraordinary with our award-winning interior design services. We create beautiful, functional environments that reflect your unique style and enhance your lifestyle.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#portfolio" className="text-gray-300 hover:text-amber-400 transition-colors duration-300">Portfolio</a></li>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Creative District, NY 10001</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">hello@hauslineinterior.com</p>
              </div>
            </div>
          </div>
        </div>
